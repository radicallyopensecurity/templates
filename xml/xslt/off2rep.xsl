...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        ...
        <pentest_report xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
            ...
            xmlns:xi="http://www.w3.org/2001/XInclude" findingCode="XXX">
            <meta>
                ...
                <version_history>
                    ...
                    <version number="auto">
                        <xsl:attribute name="date"><xsl:value-of select="format-date(current-date(), '[Y]-[M,2]-[D1]', 'en', (), ())"/><xsl:value-of select="/*/version/@date"
